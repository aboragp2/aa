...
PS4["13.50"] = {
  fw_status:
    ...
    "kpatch=1350.bin-BUILT-10/10-neg-controls-pass-UNTESTED-on-hw payload=GoldHEN_v2.4b18.12.bin-PS4HEN(works<=13.52) bug=663",
  ...
  payload: "GoldHEN_v2.4b18.12.bin", // PS4-HEN, works through 13.52
};
...
PS4["13.52"] = Object.assign({}, PS4["13.50"], {
  ...
  fw_status:
    ...
    "payload=GoldHEN_v2.4b18.12.bin-PS4HEN-native-1352 (patched-GoldHEN KP'd 2/2) " +
    "bug=663",
});
...
PS4["13.02"] = Object.assign({}, PS4["13.00"], {
  ...
  payload: "GoldHEN_v2.4b18.12.bin", // PS4-HEN, works through 13.52; replaces the non-shipped 13.00 placeholder
  fw_status:
    ...
    "kpatch=1302.bin-HW-PROVEN-KEXEC-rc0 payload=GoldHEN_v2.4b18.12-PS4HEN(works<=13.52) bug=663",
});
...
PS4["13.04"] = Object.assign({}, PS4["13.00"], {
  ...
  fw_status:
    ...
    "kpatch=1302.bin-shared-HW-PROVEN payload=GoldHEN_v2.4b18.12.bin-PS4HEN(works<=13.52) bug=663",
});
